...
public class Browser {
	...
	private static final String DEFAULT_DRIVER_PATH = System.getProperty("user.dir") + "/src/test/resources/drivers/";
	...
	private String getDefaultDriverPath() {
		String driverPath = null;

		if (SystemUtils.IS_OS_WINDOWS) {
			if (browserType.equals(BrowserType.CHROME))
				driverPath = DEFAULT_DRIVER_PATH + "windows/chromedriver.exe";
			else if (browserType.equals(BrowserType.FIREFOX))
				driverPath = DEFAULT_DRIVER_PATH + "windows/geckodriver.exe";
		} else {
			if (browserType.equals(BrowserType.CHROME))
				driverPath = DEFAULT_DRIVER_PATH + "linux/chromedriver";
			else if (browserType.equals(BrowserType.FIREFOX))
				driverPath = DEFAULT_DRIVER_PATH + "linux/geckodriver";
		}
