...
import br.com.lgigek.test.Element;
...
public class StepDefinition {
	...
	public void verifyIfGoogleHomePageIsDisplayed() {
		assertTrue(new Element(By.name("q")).getWebElement().isDisplayed());
	}
	...
	public void verifyIfFacebookHomePageIsDisplayed() {
		assertTrue(new Element(By.id("email")).getWebElement().isDisplayed());
	}
